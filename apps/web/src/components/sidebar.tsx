        ...
        <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-slate-900 px-6 pb-4">
            ...
            <nav className="flex flex-1 flex-col">
                <ul role="list" className="flex flex-1 flex-col gap-y-7">
                    <li>
                        <Button asChild className="w-full justify-start gap-2 mb-4 bg-emerald-600 hover:bg-emerald-500 text-white border-none">
                    ...
                    <li className="mt-auto">
                        <div className="flex flex-col gap-4 border-t border-slate-800 pt-4">
                            <div className="flex items-center gap-x-4 px-2 py-3 text-sm font-semibold leading-6 text-white overflow-hidden">
                                <div className="h-8 w-8 rounded-full bg-slate-800 flex items-center justify-center text-emerald-400">
